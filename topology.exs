defmodule Topology do
  def create(type, actor_list) do
    case type do
      ...
      "impLine" -> ImperfectLine.create(actor_list)
    end
  end
end
...
defmodule ThreeD do
  def create(actor_list) do
    n = trunc(:math.ceil(:math.pow(length(actor_list), 0.33)))
    IO.puts "N #{n}"
  ...
  defp inner_loop(z,  r, n, matrix, actor_list) do
    ...
    inner_loop(z, r+1, n, matrix++row, actor_list)
  end
